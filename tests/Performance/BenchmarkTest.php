...
class BenchmarkTest extends TestCase
{
    ...
    public function testIntegerListInsertionPerformance(): void
    {
        ...
        foreach ($sizes as $size) {
            ...
            $results[$size] = $time;
            $this->assertLessThan($size * 0.001, $time, "Insertion of $size integers took too long");
        }
    ...
    public function testStringListInsertionPerformance(): void
    {
        ...
        foreach ($sizes as $size) {
            ...
            $results[$size] = $time;
            $this->assertLessThan($size * 0.001, $time, "Insertion of $size strings took too long");
        }
    ...
    public function testFloatListInsertionPerformance(): void
    {
        ...
        foreach ($sizes as $size) {
            ...
            $results[$size] = $time;
            $this->assertLessThan($size * 0.001, $time, "Insertion of $size floats took too long");
        }
    ...
    public function testRemovalPerformance(): void
    {
        ...
        foreach ($sizes as $size) {
            ...
            $results[$size] = $time;
            $this->assertLessThan($size * 0.001, $time, "Removal of $size/2 elements took too long");
        }
    ...
    public function testSizePerformance(): void
    {
        ...
        $this->assertLessThan(0.01, $time, "Size operation should be O(1) constant time");
    }
    ...
    public function testClearPerformance(): void
    {
        ...
        $this->assertLessThan(0.001, $time, "Clear operation should be O(1) constant time");
